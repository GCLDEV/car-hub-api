...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  collectionName: 'cars';
  info: {
    description: 'Car listings for the marketplace';
    displayName: 'Car';
    pluralName: 'cars';
    singularName: 'car';
  };
...
export interface ApiFavoriteFavorite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User favorites for cars';
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Messages between users for car inquiries';
    displayName: 'Message';
    pluralName: 'messages';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    cityState: Schema.Attribute.String;
    confirmationToken: Schema.Attribute.String & Schema.Attribute.Private;
    confirmed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dealerInfo: Schema.Attribute.JSON;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    favorites: Schema.Attribute.Relation<'oneToMany', 'api::favorite.favorite'>;
    isDealer: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
